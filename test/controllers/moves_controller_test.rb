...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { game_id: @move.game_id, number: @move.number, user_id: @move.user_id, value: @move.value }
    end
  ...
  test "should update move" do
    patch :update, id: @move, move: { game_id: @move.game_id, number: @move.number, user_id: @move.user_id, value: @move.value }
    assert_redirected_to move_path(assigns(:move))
  end
