...
#u1 = User.create!( name: 'Alex', email: 'a@a.com', password: 'password')
#u2 = User.create!( name: 'Gerry', email: 'b@b.com', password: 'password')
#u3 = User.create!( name: 'Barry', email: 'c@c.com', password: 'password')
#
#g1 = Game.create!( user_id: u1.id, opponent_id: u2.id, diff: 3, result: 'w')
