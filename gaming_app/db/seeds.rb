...
#u2 = User.create!( name: 'Gerry' email: 'b@b.com')
#u3 = User.create!( name: 'Barry' email: 'a@a.com')
#
#g1 = Game.create!( user_id: u1.id, opponent_id: u2.id, diff: , ##result: 'w')
#g2 = Game.create!( user_id: u3.id, opponent_id: u2.id, diff: , ##result: 'w')
#
